...
API.add_resource(Ans, '/api/v1/questions/answers/')
API.add_resource(Answers, '/api/v1/questions/<int:question_id>/answers/')
API.add_resource(Answer, '/api/v1/questions/<int:question_id>/answers/<int:answer_id>/')
API.add_resource(User, '/api/v1/auth/signup/')
API.add_resource(UserLogin, '/api/v1/auth/login/')
API.add_resource(GetUserRequests, '/api/v1/questions/users/<int:user_id>/')
